--PGPASSWORD=postgres psql -U postgres -h localhost -p 54322 -f supabase/migrations/20241005160133_original-dll.sql
...
declare
  new_post_id uuid;
begin
  -- Insert into posts table and get the new post ID
